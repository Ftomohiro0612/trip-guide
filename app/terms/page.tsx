...
export default function TermsPage() {
  return (
    <LegalDocument title="利用規約">
      ...
      <section>
        <h2 className={h2Class}>2. アカウント</h2>
      ...
      <section>
        <h2 className={h2Class}>3. 禁止事項</h2>
        <ul className={listClass}>
      ...
      <section>
        <h2 className={h2Class}>4. コンテンツの取り扱い</h2>
        <ul className={listClass}>
      ...
      <section>
        <h2 className={h2Class}>5. 施設情報について（免責）</h2>
        <ul className={listClass}>
          <li>
      ...
      <section>
        <h2 className={h2Class}>6. サービスの変更・停止</h2>
        <ul className={listClass}>
      ...
      <section>
        <h2 className={h2Class}>8. 規約の改定</h2>
        <p className="mt-2">本規約を改定する場合は、サイト上で告知します。</p>
      </section>

      <section>
        <h2 className={h2Class}>9. 準拠法・管轄</h2>
        <p className="mt-2">
