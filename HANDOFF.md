...
**本番 HEAD = origin/main = `d5a29e5`**(トップ/events導線CTA。直下=`89e6f2a` 兵庫/京都Phase2イベント+24→hyogo47/kyoto38・total_events250)。**人気観光地ライン4県(大阪132+43/兵庫123+47/京都100+38/愛知125+55)すべて施設+イベント+Phase2再巡回まで完全クローズ**。
