          ...
          <div className="relative grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-relaxed text-indigo-50 sm:text-base">
                {isEventsPage
                  ? "東京・神奈川・千葉・埼玉・山梨・静岡・長野・茨城・栃木・群馬・新潟・愛知・京都・大阪・兵庫・広島・福岡・岡山・香川・熊本・長崎・大分・鹿児島・佐賀・宮崎・愛媛・徳島・高知・北海道・青森・秋田・宮城の公式確認済みの花火大会・夏祭りをまとめました。"
                  : "今週末に行ける花火やお祭りを、全国32都道府県から探せます。"}
              </p>
