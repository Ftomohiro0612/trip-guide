        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          >
            <Link
              ...
              data-seasonal-fallback="summer-2026"
              data-seasonal-layout="inline-flex"
              className="min-h-10 items-center justify-center whitespace-nowrap rounded-full bg-violet-50 px-2.5 py-1.5 text-[11px] font-bold text-violet-700"
            >
              🎪 イベント
            </Link>
            <Link
              ...
              data-seasonal-hub="summer-2026"
              data-seasonal-layout="inline-flex"
              className="min-h-10 items-center justify-center whitespace-nowrap rounded-full bg-indigo-50 px-2.5 py-1.5 text-[11px] font-bold text-indigo-700"
            >
              🎆 夏祭り・花火
            </Link>
          </span>
